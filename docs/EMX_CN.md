...
| 传感器 | | | |
| :--- | :--- | :--- | :--- |
| 测距能力<sup>1</sup> | 1.5m 至 200m (200m@10%NIST) | 精度<sup>2</sup>（典型值） | ±5 cm@1σ |
...
| 出点数 | 约 288万/s (单回波模式) |
| 出点数传输带宽 | 约 97.4Mbps (单回波模式) |

| 机械/电子操作 | | | |
| :--- | :--- | :--- | :--- |
| 工作电压 | 9V~16VDC | 尺寸 | 深102.5mm\*宽110mm\*高<br>30.4mm（冻结） |
| 产品功率<sup>3</sup> | 10W（典型值） | 工作温度<sup>4</sup> | -40℃ ~+85℃ |
| 重量 | 500g±20g (不含数据线) | 存储温度 | -40℃ ~+105℃ |
